...
For background on what eD2k servers are, how the server list works, fake servers, and how to maintain a safe server list, see [eD2k Servers](../../p2p-networks/ed2k/ed2k-servers.md).
...
The `Ed2kServersUrl` key in the `[eMule]` section of [`amule.conf`](../../manual/core/files/amule-conf.md) sets the URL used for automatic updates at startup:
