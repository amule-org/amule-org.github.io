...
The `KadNodesUrl` key in the `[eMule]` section of [`amule.conf`](../../manual/core/config-files/amule-conf.md#network-urls) configures the URL aMule uses for this download:
