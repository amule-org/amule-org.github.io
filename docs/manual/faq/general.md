...
Most of them are identical to eMule's. Detailed information about each file — and a complete list — can be found in [aMule Files](../core/config-files/index.md).
...
See [ED2KLinks file](../core/config-files/index.md) for more information.
