...
[External Connections (EC)](../../../development/ec-protocol.md) settings used by remote tools ([`amuleweb`](../../interfaces/amuleweb.md), [`amulecmd`](../../interfaces/amulecmd.md), [`amulegui`](../../interfaces/gui/amulegui.md)), plus several display and security preferences.
