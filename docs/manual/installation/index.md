...
See the [aMule Files Reference](../core/config-files/index.md) for a complete description of every file and directory created by aMule.
...
To receive a [High ID](../core/get-high-id.md) (required for optimal connectivity and download speeds), you will need to open aMule's ports on your firewall or router. The [Firewall configuration](../core/firewall.md) page explains how to do this.
