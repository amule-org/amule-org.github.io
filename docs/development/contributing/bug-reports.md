...
Valgrind helps find memory leaks, invalid reads/writes, and use-after-free errors. See [Debugging with GDB and Valgrind](../debugging.md) for the full workflow.
