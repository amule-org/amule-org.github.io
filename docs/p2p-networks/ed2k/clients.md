...
- Remote GUI ([`amulegui`](../../manual/interfaces/gui/amulegui.md)), REST API / Web UI ([`amuleapi`](../../manual/interfaces/amuleapi/index.md)), command-line interface ([`amulecmd`](../../manual/interfaces/amulecmd.md)), and legacy WebUI ([`amuleweb`](../../manual/interfaces/amuleweb.md)).
